...
import org.uniqgram.messenger.camera.CameraController;
...
import org.uniqgram.ui.Adapters.DrawerLayoutAdapter;
import org.uniqgram.ui.ActionBar.ActionBarLayout;
import org.uniqgram.ui.ActionBar.BaseFragment;
import org.uniqgram.ui.ActionBar.DrawerLayoutContainer;
import org.uniqgram.ui.Cells.LanguageCell;
import org.uniqgram.ui.Components.EmbedBottomSheet;
import org.uniqgram.ui.Components.JoinGroupAlert;
import org.uniqgram.ui.Components.LayoutHelper;
import org.uniqgram.ui.Components.PasscodeView;
...
import org.uniqgram.ui.Components.ThemeEditorView;
        ...
        if (!fromPassword && (AndroidUtilities.needShowPasscode(true) || UserConfig.isWaitingForPasscodeEnter)) {
            ...
            if (UserConfig.isClientActivated() && (flags & Intent.FLAG_ACTIVITY_LAUNCHED_FROM_HISTORY) == 0) {
                if (intent != null && intent.getAction() != null && !restore) {
                    ...
                    } else if (intent.getAction().equals("org.uniqgram.messenger.OPEN_ACCOUNT")) {
                        open_settings = 1;
